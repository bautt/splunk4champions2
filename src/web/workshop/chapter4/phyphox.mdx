...
3) Go to 
<Link to="../phyphox/download_phyphox_experiments" openInNewContext>Phyphox configuration generator dashboard </Link> and configure your experiment. This config file will contain your splunk address and the hec token, so the app will be able to send json data directly to Splunk. 
...
<table width="100%">
        ...
        Use download and "open with" or "sent to" on your phone. If you are not able to select the "phyphox app" as a destination try using Chrome on iOS. 
           ...
           <td width="70%"><img src="/static/app/splunk4champions2/images/phy_screen1-2.jpg" width="90%"/></td>
             ...
             <tr width="30%">
        <td>
    In the Phyphox app select Spluk experiments and start it. If no errors appear you have a good chance to see your data in your Splunk metric analytics.        
        </td>
