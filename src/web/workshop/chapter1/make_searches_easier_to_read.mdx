...
*On Linux or Windows use `Ctrl + \ .` OR ** `Ctrl + Shift + F` ** which works better with many non-English keyboards

*On Mac OSX use `Command + \ .`
**You can also use `Command + Shift + F`**, which works well with many non-English keyboards.
