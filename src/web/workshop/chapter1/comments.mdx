...
<div style={{padding: '1rem', backgroundColor: '#DAD7CD', 'font-family': 'Courier', 'color': '#333333', 'color': '#FFFFFF', 'font-size': '2rem'}}>
...
<Link to="https://docs.splunk.com/Documentation/Splunk/latest/Search/Comments" openInNewContext>Inline Comments Documentation</Link>
