...
| stats avg("main.temp") by name _time
| where name=="Austin" OR name=="Bonn" OR name=="Hamburg"`}>
</SplunkSearch>
...
<SplunkSearch earliest="-1y" latest="now"  spl={`index="s4c_weather"  Austin OR Bonn OR Hamburg
