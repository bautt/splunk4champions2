...
See documentation for the examples: 
<Link to="https://docs.splunk.com/Documentation/Splunk/latest/SearchReference/Commandsbytype" openInNewContext>"Command Types in Splunk Docs"</Link>
