...
<SplunkPanel dashboard="ch5_xml_pie_charts" embed={true} height="420px" />

 <Link to="ch5_xml_pie_charts" openInNewContext>Open full dashboard →</Link>
...
Another example on how to use assigned colors to create meaningful pie charts is here: 
 ...
 <Link to="ds_pie_charts" openInNewContext>Meaningful pie charts in DS</Link>
