...
Annotation search is defined immediately after the "main" search in the same chart and panel: 
...
You can also use annotations in Dashboard Studio. The syntax is a bit different: you will need a search which produces a table with 
