...
<SplunkSearch earliest="-60d" latest="now" spl={`index=s4c_weather Orlando OR Vilnius OR Frankfurt OR Brussels OR Austin OR Warsaw OR Prague OR Sydney OR Stockholm OR London OR Bonn OR Copenhagen OR Zurich
